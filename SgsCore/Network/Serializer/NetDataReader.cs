...
namespace SgsCore.Network.Serializer
{
    public class NetDataReader
    {
        ...
        public T[] GetArray<T>(ushort size)
        {
            ...
            length *= size;
            System.Buffer.BlockCopy(_data, _position, result, 0, length);
            _position += length;
            return result;
        }
        ...
        /// </summary>
        public string[] GetStringArray(int _size)
        {
            ushort length = GetUShort();
            string[] arr = new string[length];
            for (int i = 0; i < length; i++)
            {
                arr[i] = GetString(_size);
            }
            return arr;
        }
        ...
        public string GetString(int size)
        {
            ...
            return size > 0 && NetDataWriter.GbkEncoding.GetCharCount(data.Array, data.Offset, data.Count) > size ?
                string.Empty :
                NetDataWriter.GbkEncoding.GetString(data.Array, data.Offset, data.Count);
        }
        ...
        public string GetString()
        {
            ...
            return NetDataWriter.GbkEncoding.GetString(data.Array, data.Offset, data.Count);
        }
        public Span<byte> AsSpan()
        {
            Span<byte> span = new Span<byte>(_data);
            return span;
        }
        ...
        public byte[] GetRemainingBytes()
        {
            ...
            System.Buffer.BlockCopy(_data, _position, outgoingData, 0, AvailableBytes);
            _position = _data.Length;
            return outgoingData;
        }
        ...
        {
            System.Buffer.BlockCopy(_data, _position, destination, start, count);
            _position += count;
        }

        public void GetBytes(byte[] destination, int count)
        {
            System.Buffer.BlockCopy(_data, _position, destination, 0, count);
            _position += count;
        }
        ...
        public string PeekString(int maxLength)
        {
            ...
            return maxLength > 0 && NetDataWriter.GbkEncoding.GetCharCount(_data, _position + 2, actualSize) > maxLength ?
                string.Empty :
                NetDataWriter.GbkEncoding.GetString(_data, _position + 2, actualSize);
        }
        ...
        public string PeekString()
        {
            ...
            return NetDataWriter.GbkEncoding.GetString(_data, _position + 2, actualSize);
        }
        #endregion

...
namespace SgsCore.Network.Serializer
{
    public class NetDataWriter
    {
        ...
        public static readonly Encoding GbkEncoding;
        static NetDataWriter()
        {
            Encoding.RegisterProvider(CodePagesEncodingProvider.Instance);
            GbkEncoding = Encoding.GetEncoding("GB18030");
        }
        ...
        public byte[] CopyData()
        {
            ...
            System.Buffer.BlockCopy(_data, 0, resultData, 0, _position);
            return resultData;
        }
        ...
        public void Put(byte[] data, int offset, int length)
        {
            ...
            System.Buffer.BlockCopy(data, offset, _data, _position, length);
            _position += length;
        }
        ...
        public void Put(byte[] data)
        {
            ...
            System.Buffer.BlockCopy(data, 0, _data, _position, data.Length);
        ...
        public void PutSBytesWithLength(sbyte[] data, int offset, ushort length)
        {
            ...
            System.Buffer.BlockCopy(data, offset, _data, _position + 2, length);
            _position += 2 + length;
        }
        ...
        public void PutArray(Array arr, int sz)
        {
            ...
            FastBitConverter.GetBytes(_data, _position, length);
            if (arr != null)
                System.Buffer.BlockCopy(arr, 0, _data, _position + 2, sz);
            _position += sz + 2;
        }
        ...
        public void PutArray(string[] value, int size)
        {
            ushort strArrayLength = value == null ? (ushort)0 : (ushort)value.Length;
            Put(strArrayLength);
            for (int i = 0; i < strArrayLength; i++)
        ...
        public void Put(string value, int size = 0)
        {
            ...
            {
                size = value.Length;
                Put(checked((ushort)(value.Length)));
            }

            if(value != null)
            {
                GbkEncoding.GetBytes(value, 0, value.Length, _stringBuffer, 0);
            }
